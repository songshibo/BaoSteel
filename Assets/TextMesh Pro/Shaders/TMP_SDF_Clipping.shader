Shader "TextMeshPro/Distance Field Clipping"
{
    Properties {
        ...
        // CLipping Parameters
        _VerticalPlane      ("Vertical Plane", vector) = (0,0,0,0)
        _VerticalNormal     ("Vertical Normal", vector) = (0,0,0,0)
        _TopPlane           ("Top Plane", vector) = (0,200,0,0)
        _BottomPlane        ("Bottom Plane", vector) = (0,0,0,0)
    ...
    SubShader
    {
        ...
        Pass {
            ...
            pixel_t VertShader(vertex_t input)
            {
                ...
                output.positionWS = mul(unity_ObjectToWorld, float4(vert.xyz, 1)).xyz;

Shader "Custom/Tessellation Lit"
{
    Properties
    {
        ...
        _TessellationFactor("Tessellation factor", Range(1, 64)) = 1.0
        ...
        _TessellationShapeFactor("Tessellation shape factor", Range(0, 1)) = 0.75
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex PackAttributesToDS
            #pragma hull Hull
            #pragma domain Domain
            #pragma fragment LitPassFragment

            #include "TessellationLitInput.hlsl"
            #include "TessellationLitForwardPass.hlsl"
        ...
        Pass
        {
            ...
            #pragma vertex ShadowPassPackAttributesToDS
            #pragma hull Hull
            #pragma domain Domain
            #pragma fragment ShadowPassFragment

            #include "TessellationLitInput.hlsl"
            #include "TessellationShadowCasterPass.hlsl"
            #include "TessellationCommon.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #pragma vertex DepthOnlyPackAttributesToDS
            #pragma hull Hull
            #pragma domain Domain
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.TessellationLitShader"
}